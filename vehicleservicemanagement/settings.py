...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'amdadulhaque10234@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'gdty jxsw phgb uvnq' # host email password required
